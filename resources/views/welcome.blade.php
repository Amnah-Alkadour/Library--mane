...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true"
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 pb-3">
                    <div class="icon-box d-flex">
                        ...
                        <div class="icon-box-content">
                            <h3 class="card-title text-uppercase text-dark">نجيب محفوظ</h3>
                            <p>نجيب محفوظ (1911-2006) هو أديب مصري وأول عربي يحصل على جائزة نوبل في الأدب. اشتهر
                                برواياته التي تعكس حياة المجتمع المصري.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-3">
                    <div class="icon-box d-flex">
                        ...
                        <div class="icon-box-content">
                            <h3 class="card-title text-uppercase text-dark">جبران خليل جبران</h3>
                            <p>جبران خليل جبران (1883-1931) هو كاتب وشاعر لبناني أمريكي. كتب العديد من الكتب التي تأثرت
                                بالروحانية والتأملات الفلسفية، أشهرها "النبي".</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-3">
                    <div class="icon-box d-flex">
                        ...
                        <div class="icon-box-content">
                            <h3 class="card-title text-uppercase text-dark">الأديب ميخائيل نعيمة</h3>
                            <p>ميخائيل نعيمة (1889-1988) هو كاتب وشاعر لبناني، عُرف بكتاباته التي تمزج بين الأدب العربي
                                والمفاهيم الغربية.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 pb-3">
                    <div class="icon-box d-flex">
                        ...
                        <div class="icon-box-content">
                            <h3 class="card-title text-uppercase text-dark">أدباء نزار قباني</h3>
                            <p>نزار قباني (1923-1998) هو شاعر سوري اشتهر بكتابات عن الحب، والثورة، والمجتمع. تُرجمت
                                أعماله إلى عدة لغات ولقيت شهرة واسعة.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="display-header d-flex justify-content-between pb-3">
                    ...
                    <div class="btn-right">
                        <a href="/allbook"
                            class="btn btn-medium btn-normal text-uppercase">{{ __('message.panerbuttom') }}</a>
                    </div>
                </div>
                                    ...
                                    <div class="cart-concern position-absolute">
                                        <div class="cart-button d-flex">
                                            <form action="{{ route('readingbook.store') }}" method="POST"> 
                                                ...
                                                <input type="hidden" name="BookingPeriod" value="{{ now() }}">
    ...
    <section id="latest-blog" class="padding-large">
        <div class="container">
            <div class="row">
                <div class="display-header d-flex justify-content-between pb-3">
                    <h2 class="display-7 text-dark text-uppercase">{{ __('message.mostcatigory') }}</h2>
                </div>
                <div class="post-grid d-flex flex-wrap justify-content-between">
                    @foreach ($catigores as $item)
                        <div class="col-lg-4 col-sm-12">
                            ...
                            <div class="card-body text-uppercase">
                                <h3 class="card-title">
                                    <a href="{{ route('allbook.index', ['categoryId' => $item->id]) }}">
                                        {{ $item->name }}
                                    </a>
                                </h3>
                                <div class="card-meta text-muted">
                                    <span class="meta-category">{{ $item->description }}</span>
                                </div>
                            </div>
                        </div>
                    @endforeach
        ...
        <div class="container">
            <div class="row d-flex flex-wrap justify-content-between">
                <div class="col-12 text-center">
                    <div class="copyright">
                        <p>© Copyright 2024. Design by <a href="#">Aamna kadour</a>
